 ...
 */
const providerConfig: Record<ProviderType, { label: string; icon: React.ReactNode }> = {
	postgres: { label: "PostgreSQL", icon: <Database className="size-4" /> },
	mysql: { label: "MySQL", icon: <Database className="size-4" /> },
	sqlite: { label: "SQLite", icon: <Database className="size-4" /> },
	mongodb: { label: "MongoDB", icon: <Database className="size-4" /> },
	redis: { label: "Redis", icon: <Database className="size-4" /> },
};
		...
		<form onSubmit={handleSubmit} className={cn("space-y-6 overflow-x-hidden", className)}>
			...
			>
				...
				<TabsContent value="fields" className="space-y-6">
					...
					<FormField
						label="Database Type"
						error={form.errors.providerType}
						required
					>
						<Select
			...
			<Accordion type="single" collapsible className="w-full">
				<AccordionItem value="advanced" className="border border-b rounded-lg">
					...
					<AccordionContent className="px-4 pb-4 space-y-6">
						...
						<div className="space-y-4">
							...
							<FieldGroup>
								...
								>
									<Input
										...
										onChange={(e) => form.setField("maxPoolSize", parseInt(e.target.value, 10) || 10)}
										min={1}
										max={100}
									/>
								</FormField>
								...
								>
									<Input
										...
										onChange={(e) => form.setField("idleTimeoutMs", parseInt(e.target.value, 10) || 30000)}
										min={0}
										max={3600000}
									/>
								</FormField>
							...
							>
								<Input
									...
									onChange={(e) => form.setField("connectionTimeoutMs", parseInt(e.target.value, 10) || 5000)}
									min={100}
									max={60000}
								/>
							</FormField>
						...
						<div className="space-y-4">
							...
							<FormField
								label="Color"
								hint="Color label for visual identification"
							>
								<Input
									type="color"
							...
							<FormField
								label="Notes"
								hint="Optional notes about this connection"
							>
								<Textarea
